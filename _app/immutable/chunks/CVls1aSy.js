...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Ul(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Eo(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Nl(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Eo(),fragmentShader:`
...
`].filter(or).join(`
`)),o=eo(o),o=Yl(o,e),o=ql(o,e),a=eo(a),a=Yl(a,e),a=ql(a,e),o=Zl(o),a=Zl(a),e.isRawShaderMaterial!==!0&&(T=`#version 300 es
